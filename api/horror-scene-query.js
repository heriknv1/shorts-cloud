...
function fallback(description,narration){
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    primary=`${primary} psychological horror suspense cinematic low key lighting non graphic`.slice(0,210);
    backup=`${backup} alternate angle cinematic suspense practical light deep shadows`.slice(0,210);
