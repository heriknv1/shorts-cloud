...
function minNarrationWords(duration,speed){return Math.round(targetNarrationWords(duration,speed)*0.88)}
function maxNarrationWords(duration,speed){return Math.round(targetNarrationWords(duration,speed)*1.08)}
